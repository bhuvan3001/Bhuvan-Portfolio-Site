<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="Registration.aspx.cs" Inherits="Bhuvan_Portfolio_Site.Registration" %>
...
<asp:RegularExpressionValidator ID="rev1" runat="server" ControlToValidate="txtEmail" Display="Dynamic" ErrorMessage="* Must be an email" ValidationExpression="\w+([-+.']\w+)*@\w+([-.]\w+)*\.\w+([-.]\w+)*"></asp:RegularExpressionValidator>
</td>
</tr>
<tr>
<td style="text-align: right; width: 440px">Confirm Email:</td>
<td style="width: 482px">
<asp:TextBox ID="txtCEmail" runat="server"></asp:TextBox>
</td>
<td style="text-align: left; width: 633px">
<asp:CompareValidator ID="cv1" runat="server" ControlToCompare="txtEmail" ControlToValidate="txtCEmail" ErrorMessage="* Values must be same"></asp:CompareValidator>
</td>
</tr>
<tr>
...
<td style="text-align: left; width: 633px">
<asp:RequiredFieldValidator ID="rfv2" runat="server" ControlToValidate="txtPswd" ErrorMessage="* Required"></asp:RequiredFieldValidator>
</td>
</tr>
<tr>
...
<td style="text-align: right; width: 440px"> </td>
<td style="width: 482px">
<asp:Button ID="btnRegister" runat="server" OnClick="btnRegister_Click" Text="Register" Width="247px" />
</td>
<td style="text-align: left; width: 633px"> </td>
</tr>
<tr>
